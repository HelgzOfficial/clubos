    ...
    <div>
      ...
      {editing ? (
        ...
        <div className="space-y-4">
          ...
          {/* Directly under the emergency contact, not filed away at the
              bottom: an ambulance crew asks for date of birth and an address,
              and hunting for them is exactly the wrong thing to be doing. */}
