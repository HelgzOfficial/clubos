...
import { MatchAndSeasonStats } from "@/components/analysis/match-and-season-stats";
...
const TABS: { key: Tab; label: string; icon: typeof Save }[] = [
  ...
  { key: "games", label: "Games & Averages", icon: CalendarDays },
  ...
  return (
    <AppShell>
      ...
      {loading ? (
        ...
        <MatchAndSeasonStats
          players={players} matches={matches} metrics={activeMetrics} allStats={allStats}
        />
      ) : tab === "risk" ? (
