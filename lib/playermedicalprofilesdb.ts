...
// Every field is a plain string here, not `string | null` like the database
// row. A form input's value can't be null, and mapping null to "" at the edge
// keeps that conversion in one place instead of at every field.
