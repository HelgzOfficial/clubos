...
export default function PortalPage() {
  ...
  const formGuide = useMemo(() => {
    // recentResults is newest-first and holds up to 15 (for the Results
    // tab) — the form strip only ever wants the last 5, oldest-to-newest.
    return [...recentResults].slice(0, 5).reverse().map((m) => {
